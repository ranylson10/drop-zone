...
export default function AbaInformacoes({ camp, onSave }: AbaInformacoesProps) {
 ...
 const aplicarPadraoCompetitivo = async () => {
 const padraoCompetitivo = [12, 9, 8, 7, 6, 5, 4, 3, 2, 1, 0, 0]
 setPontos(padraoCompetitivo)
 await onSave('pontos_colocacao', padraoCompetitivo)
 }
 ...
 <button onClick={aplicarPadraoCompetitivo} className="text-[10px] font-semibold bg-zinc-100 px-3 py-1 border border-zinc-200 hover:bg-white hover:text-[#2563eb] transition-all">
 Usar padrão competitivo
 </button>
 </div>
