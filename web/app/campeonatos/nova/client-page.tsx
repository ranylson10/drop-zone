...
const OPCOES: Array<{
 ...
 badge: 'Mata-mata',
 titulo: 'COPA',
 descricao: 'Mata-mata com chave e avanço de fase.',
 icon: Swords,
 },
 {
 slug: 'liga',
...
function PageInner() {
 ...
 <div className="mt-1 text-[24px] font-semibold text-[#142340]">4</div>
 </div>
 ...
 <div className="text-[10px] font-medium uppercase tracking-[0.18em] text-zinc-500">Mata-mata</div>
 <div className="mt-1 text-[24px] font-semibold text-[#142340]">Copas e ligas</div>
 </div>
