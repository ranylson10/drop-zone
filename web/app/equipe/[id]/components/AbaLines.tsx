    ...
    <div className="space-y-6">
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="mt-3 text-[12px] font-semibold text-zinc-600">
              Crie lines prontas para usar em campeonatos, diários e para importar o elenco inteiro.
            </p>
          </div>
          {canManage ? (
      ...
      <div className="border border-zinc-200 bg-zinc-50 p-5">
        <div className="flex flex-wrap gap-4 text-[10px] font-semibold uppercase tracking-[0.14em] text-zinc-500">
          ...
          <span className="inline-flex items-center gap-2"><Layers3 size={12} /> Base pronta para campeonatos</span>
        </div>
      </div>
    </div>
  );
