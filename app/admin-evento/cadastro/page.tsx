...
type TipoEvento = 'apostado' | 'confronto' | 'diario' | 'xtreino' | 'copa' | 'liga'
...
const TIPOS: Array<{ value: TipoEvento; label: string; desc: string }> = [
 { value: 'apostado', label: 'Apostados', desc: 'Desafios entre 2 lados com valor retido e payout ao vencedor.' },
 { value: 'confronto', label: 'Confrontos', desc: 'Campeonatos de confronto, de 1x1 até 4x4.' },
...
export default function CadastroAdminEventoPage() {
 ...
 <div className="mt-4 border border-red-500/20 bg-red-500/5 px-4 py-3 text-sm text-red-200">
 ...
 {erro ? (
 <div className="mt-6 flex items-start gap-3 border border-red-500/30 bg-red-500/10 px-4 py-3 text-sm text-red-100">
 ...
 {sucesso ? (
 <div className="mt-6 flex items-start gap-3 border border-emerald-500/30 bg-emerald-500/10 px-4 py-3 text-sm text-emerald-100">
 ...
 disabled={salvando}
 className="inline-flex items-center gap-2 bg-[#2563eb] px-5 py-3 text-[10px] font-semibold uppercase tracking-[0.24em] text-[#142340] transition hover:bg-[#1d4ed8] hover:text-white disabled:cursor-not-allowed disabled:opacity-50"
 >
