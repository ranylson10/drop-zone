export type TipoCompeticao = 'confronto' | 'diario' | 'xtreino' | 'copa' | 'liga'
...
export const TIPOS_COMPETICAO: Array<{
...
}> = [
  {
    slug: 'confronto',
    titulo: 'CONFRONTOS',
    subtitulo: 'Sistema de confrontos com múltiplos modos: 1x1, 2x2, 2x3 e 4x4.',
    modelo: 'confronto',
    formatoBanco: 'confronto',
    hrefLista: '/campeonatos/confrontos',
    hrefCriacao: '/campeonatos/nova/confronto',
    badge: 'Confronto',
  },
  {
    slug: 'diario',
  ...
  },
  {
    slug: 'copa',
    titulo: 'COPA',
    subtitulo: 'Mata-mata com chave, avanço de fase e decisão por confronto.',
    modelo: 'copa',
    formatoBanco: 'Copa',
...

  {
    slug: 'apostado',
    titulo: 'APOSTADO',
    subtitulo: 'Disputa direta entre duas equipes com valor casado. Quem vencer leva tudo.',
    modelo: 'apostado',
    formatoBanco: 'Apostado',
    hrefLista: '/apostados',
    hrefCriacao: '/campeonatos/nova/apostado',
    badge: 'Valor casado',
    usaCampeonatos: false,
  },
]
...
export function normalizarTipoCompeticao(input: unknown): TipoCompeticao | null {
  ...
  if (valor === '4x4' || valor === 'confronto') return 'confronto'
...
export function resolverTipoCompeticao(camp: any): TipoCompeticao | null {
  return normalizarTipoCompeticao(
    camp?.tipo_competicao || camp?.formato || camp?.modelo_competicao,
  )
}
